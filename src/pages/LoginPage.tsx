...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-700 via-blue-400 to-white p-2 sm:p-4">
      <div className="w-full max-w-5xl bg-white/60 rounded-2xl shadow-2xl flex flex-col md:flex-row overflow-hidden relative">
        {/* Left: Login Form */}
        <div className="w-full md:w-1/2 flex flex-col justify-center p-4 sm:p-8 md:p-12 min-w-0">
          {/* Logo */}
          ...
          <Card className="shadow-none border-0 bg-transparent p-0">
            <CardHeader className="text-left pb-6">
              <CardTitle className="text-3xl font-extrabold text-blue-900 mb-2">Welcome Back</CardTitle>
              <CardDescription className="text-blue-700/80 text-base font-medium mb-4">Sign in to your account to manage your cleaning services</CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <div className="text-center mt-4">
                <p className="text-blue-900/70">
                  ...
                  <a href="/signup" className="text-blue-500 hover:text-blue-700 font-medium transition-colors duration-200">
                    Sign up for free
                  </a>
                </p>
              </div>
