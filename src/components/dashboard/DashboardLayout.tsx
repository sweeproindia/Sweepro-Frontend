...
export const DashboardLayout = ({ children }: DashboardLayoutProps) => {
  ...
  // Sample notification data for user
  const notifications = [
    {
      id: 1,
      type: 'user',
      title: 'Booking Confirmed',
      message: 'Your cleaning service for tomorrow at 10 AM has been confirmed',
      time: '5 minutes ago',
      unread: true
    },
    {
    ...
    },
    {
      ...
      type: 'maid',
      title: 'Maid Assigned',
      message: 'Priya Sharma has been assigned to your cleaning service',
      time: '2 hours ago',
      unread: false
    },
    {
      ...
      message: 'Don\'t forget your scheduled cleaning service tomorrow',
      time: '1 day ago',
      unread: false
    },
    {
      ...
      type: 'admin',
      title: 'Special Offer',
      message: 'Get 20% off on your next booking with code CLEAN20',
      time: '2 days ago',
      unread: false
    },
    {
      ...
      message: 'Your cleaning service has been completed successfully',
      time: '3 days ago',
      unread: false
    },
    {
    ...
    },
    {
      ...
      type: 'user',
      title: 'New Feature',
      message: 'Check out our new mobile app features for easier booking',
      time: '1 week ago',
      unread: false
    },
    {
      ...
      message: 'Your cleaning schedule has been updated due to maid availability',
      time: '2 weeks ago',
      unread: false
    }
  ];
