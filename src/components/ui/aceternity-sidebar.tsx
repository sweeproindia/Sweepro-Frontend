...
export const DesktopSidebar = ({
  ...
  return (
    <>
      <motion.div
        className={cn(
          "h-full px-4 py-4 hidden lg:flex lg:flex-col bg-neutral-100 dark:bg-neutral-800 w-[300px] shrink-0 [&::-webkit-scrollbar]:hidden [scrollbar-width:none] [ms-overflow-style:none]",
          className
        )}
        animate={{
