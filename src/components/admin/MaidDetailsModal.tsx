      ...
      <Card className="w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <CardContent className="pt-6 space-y-6">
          ...
          <div className="space-y-2 bg-green-50 border border-green-200 rounded-lg p-4">
            <div className="flex items-center gap-2">
              <Badge variant="outline" className="bg-green-100">🔑 Verification Code</Badge>
            </div>
            {maid.verificationCode ? (
              <p className="text-2xl font-mono font-bold tracking-widest text-green-900">
                {maid.verificationCode}
              </p>
            ) : (
              <p className="text-sm text-gray-500">No verification code set</p>
            )}
            <p className="text-xs text-green-700 mt-1">
              Customers use this code to complete bookings
            </p>
          </div>
